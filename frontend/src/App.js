...
import AddUser from './Components/PlaygroundForm/PlaygroundFrom';
import EAddUser from './Components/PlaygroundForm/EnglishPlaygroundFrom.js';
import TAddUser from './Components/PlaygroundForm/TamilPlaygroundFrom.js';
...
import ECrematoriumForm from './Components/CrematoriumForm/EnglishCrematorumFrom.js';
import TCrematoriumForm from './Components/CrematoriumForm/TamilCrematoriumFrom.js'
    ...
    <div className="App">
      <React.Fragment>
        <Routes>
          ...
          <Route path="/ecrematorium" element={<ECrematoriumForm />} />
          <Route path="/tcrematorium" element={<TCrematoriumForm />} />
          <Route
            path="/admincheck"
            element={
              <ProtectedRoute
