...
const AdminHome = () => {
  ...
  const moduleStats = {
    ...
    inventory: { totalItems: 2847, lowStock: 23, pending: 45, recentOrders: 156 }
  };
  ...
  const modules = [
    {
      ...
      titleSinhala: 'පැමිණිලි සහ නිවේදන',
      icon: MessageSquare,
      color: 'green',
    ...
    },
    {
      ...
      icon: CreditCard, // or FileText/ClipboardList/Building2
      color: 'orange',
      description: 'Shop assessment and registration management',
      route: '/officerdisplaypage'
  ...
  const slides = [
    {
      image: "/horanaUrban/officeBoard.png",
    ...
    {
      image: "/horanaUrban/digitalScreen.png",
  ...
  // Add photos: use public folder web paths like /Staff/semal.jpg
  const officers = [
    {
      name: 'Dilmi chamya',
      ...
      status: 'online',
      photo: '/Staff/dilmi.jpg' // add if you have it
    },
    {
      name: 'Dilmi chamya',
      ...
      status: 'online',
      photo: '/Staff/dilmi.jpg'
    },
    {
      name: 'Semal amarajeewa',
      title: 'Permit & Service Approve Officer',
      department: 'Legal Affairs',
      profileLink: '/profile/permit-approve-officer',
      status: 'online',
      photo: '/Staff/semal.jpg' // <-- your file in public/Staff/
    },
    {
      name: 'pasindu kavishka',
      title: 'complaint manager',
      department: 'Customer Service',
      profileLink: '/profile/service-officer',
      status: 'online',
      photo: '/Staff/pasindu.jpg'
    },
    {
      name: 'Sanuk hansana',
      ...
      <main className={`transition-all duration-300 ${sidebarCollapsed ? 'ml-20' : 'ml-72'}`}>
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {modules.map((module) => {
              const Icon = module.icon; // <-- FIX: use a proper component variable
              return (
                <div
                  key={module.id}
