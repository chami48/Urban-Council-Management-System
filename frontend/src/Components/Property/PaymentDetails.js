...
const PaymentDetailsPage = () => {
  const [paymentAmount, setPaymentAmount] = useState(14472.5);
      ...
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg">
        ...
        <div className="p-6 border-b">
          ...
          <div className="text-sm text-gray-600">
            Original Amount: LKR 14,472.50
          </div>
        </div>

        {/* Payment Details Form */}
        <div className="p-6 space-y-4">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Payer Information</h3>
        ...
        <div className="p-6 bg-blue-50 border-t">
          ...
          <div className="flex justify-between items-center text-lg">
            ...
            <span className="font-bold text-blue-600">LKR {paymentAmount.toLocaleString()}</span>
          </div>
        </div>
